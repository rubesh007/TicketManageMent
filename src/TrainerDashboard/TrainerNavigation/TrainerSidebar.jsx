...
const TrainerSideBar = ( { darkMode, sidebarOpen, setSidebarOpen } ) => {
    ...
    const sidebarItems = [
        ...
        },
        {
            ...
            subItems: [
                { name: 'Add Student', icon: <FiUser className="w-4 h-4" />, path: '/trainer/add-student' },
                { name: 'Enrollments', icon: <FiCheckSquare className="w-4 h-4" />, path: '/trainer/enrollments' },
                { name: 'Attendence', icon: <FiUserCheck   className="w-4 h-4" />, path: '/trainer/student-Attendence' },
                { name: 'Progress', icon: <FiPieChart className="w-4 h-4" />, path: '/trainer/student-progress' }
            ]
        },
        {
            ...
            subItems: [
                { name: 'Mock Interview', icon: <FiAward className="w-4 h-4" />, path: '/trainer/mock-interview' },
                { name: 'Internship', icon: <FiBriefcase className="w-4 h-4" />, path: '/trainer/internship' },
                { name: 'Projects', icon: <FiCode className="w-4 h-4" />, path: '/trainer/projects' },
                { name: 'Tasks', icon: <FiClipboard className="w-4 h-4" />, path: '/trainer/tasks' },
                { name: 'Tests', icon: <FiCheckSquare className="w-4 h-4" />, path: '/trainer/tests' }
            ]
        }
    ];
    ...
    return (
        <div className={ `flex flex-col h-screen transition-all duration-300 ease-in-out ${ sidebarOpen ? 'w-64' : 'w-20 flex flex-col justify-center items-center' } ${ darkMode ? 'bg-gray-900 text-white' : 'bg-white text-black' }` }>
            <div className="flex flex-col flex-1 border-r-2 border-gray-400 shadow-sm">
                {/* Header */ }

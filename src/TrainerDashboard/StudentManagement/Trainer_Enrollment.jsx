...
const Trainer_Enrollment = () => {
    ...
    // ID generation
    const GenerateID = () => {
        const stored = JSON.parse( localStorage.getItem( "TrainerEnrollments" ) || "[]" );
        let newId;
    ...
    const handleSubmit = ( e ) => {
        ...
        localStorage.setItem( "TrainerEnrollments", JSON.stringify( updated ) );
        setFormData( {
            id: "",
            studentname: "",
            course: "",
...
export default Trainer_Enrollment;
...
export const Internship = () => {
    const [ addInternshipBtn, setAddInternshipBtn ] = useState( false );
    ...
    const handleSubmit = ( e ) => {
        e.preventDefault();
        const { name, phone, yop, qualification, doi, batchcode, trainer, internshiptitle } = InternshipDetail;

        if ( name && phone && yop && qualification && doi && batchcode && trainer && internshiptitle ) {
            const studentData = {
                ...InternshipDetail,
                id: edit !== null ? InternshipDetail.id : generateRandomId() // Keep existing ID when editing
            };
    ...
    const handleEdit = ( i ) => {
        setInternshipDetail( dataStore[ i ] );
        setEdit( i );
        setAddInternshipBtn( true );
    };
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <input
                                            ...
                                            id="batchcode"
                                            name="batchcode"
                                            value={ InternshipDetail.batchcode }
                                            onChange={ handleMockInput }
                                            required

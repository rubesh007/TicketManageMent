...
const SideBar = ( { darkMode, sidebarOpen, setSidebarOpen } ) => {
    ...
    const sidebarItems = [
        ...
        },
        {
            ...
            subItems: [
                { name: 'Add Batch', icon: <FiFolderPlus className="w-4 h-4" />, path: '/add-batch' },
                { name: 'Add Course', icon: <FiBook className="w-4 h-4" />, path: '/add-course' },
                { name: 'Add Category', icon: <FiPlusCircle className="w-4 h-4" />, path: '/add-category' },
                { name: 'Add Role', icon: <FiDollarSign className="w-4 h-4" />, path: '/add-role' }
            ]
        },
        {
            ...
            subItems: [
                { name: 'Add Teacher', icon: <FiUser className="w-4 h-4" />, path: '/add-teacher' },
                { name: 'Assign Courses', icon: <FiBook className="w-4 h-4" />, path: '/assign-courses' },
                { name: 'Schedule', icon: <FiCalendar className="w-4 h-4" />, path: '/teacher-schedule' }
            ]
        },
        {
            ...
            subItems: [
                { name: 'Add Student', icon: <FiUser className="w-4 h-4" />, path: '/add-student' },
                { name: 'Enrollments', icon: <FiCheckSquare className="w-4 h-4" />, path: '/add-enrollment' },
                { name: 'Progress', icon: <FiPieChart className="w-4 h-4" />, path: '/student-progress' },
                { name: 'studentRegister', icon: <FiPieChart className="w-4 h-4" />, path: '/student-Register' }
            ]
        },
        {
            ...
            subItems: [
                { name: 'Mock Interview', icon: <FiAward className="w-4 h-4" />, path: '/add-mock-interview' },
                { name: 'Internship', icon: <FiBriefcase className="w-4 h-4" />, path: '/add-internship' },
                { name: 'Projects', icon: <FiCode className="w-4 h-4" />, path: '/add-projects' },
                { name: 'Tasks', icon: <FiClipboard className="w-4 h-4" />, path: '/add-tasks' },
                { name: 'Tests', icon: <FiCheckSquare className="w-4 h-4" />, path: '/add-tests' }
            ]
        }
    ];
